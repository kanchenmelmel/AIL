//
//  PTEExchangeWebViewController.swift
//  AIL
//
//  Created by Wenyu Zhao on 8/4/17.
//  Copyright © 2017 au.com.melmel. All rights reserved.
//

import UIKit

class PTEExchangeWebViewController: UIViewController,UIWebViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        urlString = "http://ail.vic.edu.au/exchange/"
        ...
        post = CoreDataOperation.buildRandomPost(0, title: "PTE考位交流", excerpt: "PTE考位交流", date: Date(), link: urlString!)
    }
